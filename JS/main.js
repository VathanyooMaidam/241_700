...
*/
/**
 conditiion statement (if, else, switch)
 == เท่ากับ
 != ไม่เท่ากับ
 > มากกว่า
 >= มากกว่าเท่ากับ
...
let conditiion1 = number1 == number2 //Boolean (true,false)

console.log('Conditiion is =',conditiion1)
*/
/**
let number1 = 5
let number2 = 5
...
// T && F
let conditiion = !(number1 >= 3 || number2 >= 11)
console.log('result of condition', conditiion)
...
for (let index = 0; index < name_list.length; index++) {
    console.log('nmae list',name_list[index])
}
*/
...
let double_score =students.map(() =>{
    s.score =s.score * 2
    return
})

let highScore = studentS.filter(() =>{
    if(s.score >= 120){
        return true
    }
})
